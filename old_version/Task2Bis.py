...
for index, row in df.iterrows():
    title_tokens = preprocess_text(row['Titre'])  # Preprocess the 'Titre' of the current row
    description_tokens = preprocess_text(row['description'])  # Preprocess the 'description' of the current row
    ...
    # Ajout des tags dans le DataFrame
